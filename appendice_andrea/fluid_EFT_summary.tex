...
\end{aligned}
\end{align}
As expected, phonons $\partial_j\pi^j$ only source density fluctuations, while the entropy field $\pi^0$ sources both density and entropy fluctuations \todoAC{This is for flat spacetime, write general form in curved spacetime and $\bar{\varphi}^0$}
{\color{red}
