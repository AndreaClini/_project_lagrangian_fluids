...
The characteristic for $\beta=\log b$ is trivial and is chosen as variable to parametrize the flow, while the solution for the $\gamma=\log y$ characteristic is
{\small
\begin{align}\begin{aligned}
