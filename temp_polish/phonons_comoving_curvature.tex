...
From \label{eq:peculiar_velocity_via_phonons} we identify the comoving curvature perturbations \eqref{eq:comoving_curvature_perturbations_gauge_inv_and_newtonian} in terms of metric potentials and phonon potential
\begin{equation}
...
\end{aligned}
\end{align}}
Taking $\psi=\phi$ at \emph{late times} and in the large scale limit, and simplifying terms we \todotag{write}finally get
\begin{align}
    ...
\end{align}
