...
%---------- other math symbols ---------------
\newcommand{\revpropto}{\mathrel{\reflectbox{$\propto$}}}
...
\newpage
\appendix 
\input{appendice_andrea/notations_cosmology.tex}
\newpage
\input{appendice_andrea/fluid_EFT_summary.tex}

\newpage
\input{appendice_andrea/recovering_familiar_fluids.tex}

\newpage
\input{appendice_andrea/phonons_comoving_curvature.tex}

\newpage
\input{appendice_andrea/matching_scalar_field.tex}

\newpage
\input{appendice_andrea/todolist.tex}

\newpage
\input{appendice_andrea/5_esse.tex}

\newpage
\input{appendice_andrea/WRONG_OLD_matrching_scalar.tex}
