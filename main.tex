...
Next we get the thermo variables
\begin{align}
    \rho=\tfrac12 y^2+\beta\log b, \quad p=\tfrac12 y^2+\beta-\beta\log b=\rho+\beta-2\beta\log b, \quad \sigma=\frac{F_y}{b}=\frac{y^2}{b}.
\end{align}
We invert the expressions for $\rho$ and $\sigma$ to use them as independent variables.
Combining the equation for $\rho$ and $\sigma$
\begin{align}
...
\end{align}
Differentiating the first one wrt $\rho$ at fixed $\sigma$ we get
\begin{align}
...
\end{align}
We compare this with the explicit form
\begin{align}
...
Using $X$ and $V(\varphi)$ a variable we rewrtite the nonadiabatic pressure perturbations as
\begin{align}
...
More generally we can look for a solution of the form $F=\tfrac12 y^2 + C b^\beta$.
Then we have
\begin{align}
