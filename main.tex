...
In the 5-essence case we can express kinetic energy and potential in terms of the fluid variables as
\begin{align}
...
In turn we get
\begin{align}
    c_b^2=\frac{-b^2F_{bb}y^2F_{yy}+\big(yF_y-byF_{by}\big)^2}{y^2F_{yy}(yF_y-bF_b)}=\frac{y^2-\beta}{y^2+\beta}
\end{align}
...
From the first one
\begin{align}
    1=y\frac{\partial y}{\partial\rho}_{|\sigma}+\frac{2\beta}{y}\frac{\partial y}{\partial\rho}_{|\sigma}\quad\Rightarrow\quad \frac{\partial y}{\partial\rho}_{|\sigma}=\frac{y}{y^2+2\beta}, \quad\frac{\partial b}{\partial\rho}_{|\sigma}=\frac{2y}{\sigma}\frac{\partial y}{\partial\rho}_{|\sigma}=\frac{2y^2}{\sigma}\frac{1}{y^2+2\beta}=\frac{2b}{y^2+2\beta}
\end{align}
and
\begin{align}
    \frac{\beta}{\sigma}=y\frac{\partial y}{\partial\sigma}_{|\rho}+\frac{2\beta}{y}\frac{\partial y}{\partial\sigma}_{|\rho}\quad\Rightarrow\quad \frac{\partial y}{\partial\sigma}_{|\rho}=\frac{\beta}{\sigma}\frac{y}{y^2+2\beta}, \quad\frac{\partial b}{\partial\sigma}_{|\rho}=\frac{2y}{\sigma}\frac{\partial y}{\partial\sigma}_{|\rho}-\frac{y^2}{\sigma^2}=-\frac{y^2}{\sigma^2}\frac{y^2}{y^2+2\beta}.
\end{align}
For fluctuations we have
\begin{align}
    \delta p=\delta\rho-2\frac{\delta b}{b}= c_b^2\delta\rho+\Gamma\delta\sigma
\end{align}
We compare this with the explicit form\todotag{Made a mistake somewhere}
\begin{align}
    c_b^2:=\frac{\partial p}{\partial\rho}_{|\sigma}=1-\frac{2}{b}\frac{\partial b}{\partial\rho}_{|\sigma}=1-\frac{4}{y^2+2\beta},\qquad \Gamma:=\frac{\partial p}{\partial\sigma}_{|\rho}=-\frac{2}{b}\frac{\partial b}{\partial\sigma}_{|\rho}=+\frac{2}{b}\frac{y^2}{\sigma^2}\frac{y^2}{y^2+2\beta}=\frac{2b}{y^2+2\beta}
\end{align}


\subsubsection{Alternative solution}
Alternatively we can look for a solution $F=Cy^\alpha b^\beta$, then
\begin{align}
