...
\input{temp_polish/body_by_diego.tex}

%%%%%%%%%%%%%%%%%% APPENDIX %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\appendix 
\input{temp_polish/conventions.tex}
\newpage
\input{temp_polish/thermodynamic_formulas.tex}
\input{temp_polish/quadratic_action_curved_spacetime.tex}

\newpage
\input{temp_polish/recovering_familiar_fluids.tex}

\newpage
\input{temp_polish/phonons_comoving_curvature.tex}

\newpage
\input{temp_polish/matching_scalar_field.tex}
