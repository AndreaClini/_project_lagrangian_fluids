...
\begin{align}
\delta p &=c_b^2\delta\rho+\Gamma\delta y\ ,
\end{align}
where we defined $c_b^2=\partial p/\partial \rho\vert_s$ and $\Gamma=\partial p/\partial s\vert_\rho$. Notice that since $\dot{s}=0$ in a perfect fluid $c_b^2=c_a^2$. 
