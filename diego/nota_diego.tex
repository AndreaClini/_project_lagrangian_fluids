...
\begin{equation}
 c_s^2=\frac{b F_{bb}}{ F_b}=\frac{d p}{d\rho}=\frac{\dot{p}}{\dot{\rho}}=w-\frac{\dot{w}}{3H(1+w)}\,,  
\end{equation}
...
\end{equation}
Moreover the special functional dependence of $c_s^2$ on $w$ implies that  \questionAC{Why? By theremodyn?}
\begin{equation}
