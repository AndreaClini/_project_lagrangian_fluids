...
\end{align}
and which we can combine in the second order differential equation for the energy density fluctuations
\begin{equation}
 ...   
\end{equation}
...
\end{equation}
Mi aggiungi il matching per bene qui? pressione e la sua variazione fino alle equazione per $\delta\rho$ poi generalizza a k-essence e k essence che e' essenzialmente k essence + quintessence. A me sembra che $\Gamma$ sia funzione del potenziale ma l'equazione di stato e' non e' solo funzione del potenziale...
