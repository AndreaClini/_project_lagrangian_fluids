...
\begin{equation}
    u^\mu=\frac{1}{3!\,\,\sqrt{B}}\epsilon_{\mu\alpha\beta\gamma}\,\,\epsilon_{ijk}\,\,\partial^\alpha \phi^i \partial^\beta \phi^j \partial^\gamma \phi^k,
\end{equation}
...
\begin{align}
    \delta Y
    &= \delta\left(u^\alpha \partial_\alpha \phi^0\right)
    = (\delta u^\alpha) \partial_\alpha \phi^0
    \\
     &= -\left(u^\theta \partial_\theta \phi^0\right)\frac{1}{2}B^{-1}\, \delta B
     +\partial_\alpha\phi^0\,\,\frac{1}{3!\,\,\sqrt{B}}\epsilon_{\lambda\mu\nu\rho}\,\,\epsilon_{ijk}\,\,\partial_\beta \phi^i \partial_\gamma \phi^j \partial_\delta \phi^k 
     \,\,\delta\left(g^{\alpha\lambda}g^{\beta\mu}g^{\gamma\nu}g^{\delta\rho}\right)
     \\
     &=-\frac{Y}{2} \left\{g_{\mu\nu}+u_\mu u_\nu\right\}\,\delta g^{\mu\nu} + \left\{\partial_\alpha\phi^0\,\, u_\lambda \right\} \delta g^{\alpha\lambda}
     + 
     \partial_\alpha\phi^0\,\,\frac{1}{3!\,\,\sqrt{B}}\epsilon_{\lambda\mu\nu\rho}\,\,\epsilon_{ijk}\,\,\partial_\beta \phi^i \partial_\gamma \phi^j \partial_\delta \phi^k 
...
\begin{align}
    ...
    -\frac{1}{2} g_{\mu\nu} F
    + (\partial_BF)\, B \left(g_{\mu\nu}+u_\mu u_\nu\right) - (\partial_YF)\, \frac{Y}{2} \left(g_{\mu\nu}+ 3 \,\,u_\mu u_\nu\right)
    \\
    &\qquad
...
\begin{align}
    ...
    %
    =g_{\mu\nu} F
    -2 (\partial_BF)\, B \left(g_{\mu\nu}+u_\mu u_\nu\right) + (\partial_YF)\, Y \left(g_{\mu\nu}+ 3 \,\,u_\mu u_\nu\right).
\end{align}
