...
% Expanding up to second order in the fluctuations $\delta\varphi$ around a homogeneous background $\bar{\varphi}(t)$ we have
% \begin{align}
%     S_\varphi^{(2)} &= \int d^4x a^4 \Bigg\{
%     \frac{1}{2a^2}\left[(1-2\Phi)(\delta\varphi')^2 - (1+2\Psi)(\nabla\delta\varphi)^2\right]
%     - \frac{1}{2} V''(\bar{\varphi}) (\delta\varphi)^2
%     \nnb
%     \\
%     &\quad + \frac{1}{a^2}\left[-\bar{\varphi}'\delta\varphi' \Phi + \bar{\varphi}'\delta\varphi \Psi' \right]
%     - V'(\bar{\varphi}) \delta\varphi (\Phi - 3\Psi)
%     \Bigg\}\,.
% \end{align}
