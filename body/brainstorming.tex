...
\begin{align}
    \int d^4x\, \mathcal{L}^{(2)} 
    &= \int d^4x \bigg\{\bar{B} (\partial_B\bar{F}) \Big(\partial_\mu \pi^i \partial^\mu \pi^i
    + 2 (\partial_i \pi^i)^2 - \partial_i \pi^j \partial_j \pi^i - \partial_i \pi^j \partial_i \pi^j\Big)
    \\[4pt]
    &\qquad +
    \bar{Y}(\partial_Y\bar{F}) \tfrac12 \Big((\partial_i \pi^i)^2 -\partial_\mu \pi^i \partial^\mu \pi^i + \partial_i \pi^j \partial_j \pi^i +\partial_i \pi^j \partial_i \pi^j
    - 2 \partial_0 \pi^0 \partial_\ell\pi^\ell + \epsilon_{i j k}\epsilon^{\mu \alpha j k}  \partial_\alpha \pi^i \partial_\mu \pi^0\Big)
    \\
    &\qquad +
    \bar{B}^2 (\partial_B^2\bar{F}) \,2 \,\big(\partial_i \pi^i\big)^2
    + \tfrac{1}{2}\bar{Y}^2(\partial_{Y}^2\bar{F}) \big(\partial_0 \pi^0 - \partial_i \pi^i\big)^2
