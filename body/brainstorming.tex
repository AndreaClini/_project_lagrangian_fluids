...
\end{equation}
Recall we can identify $b:=\sqrt{B}=n$ as the number density.
...
The entropy $S$ and temperature $Y\equiv T$ are given by
\begin{equation}
    Y:=T=\frac{\partial U}{\partial S}_{\mid V,N} = \frac{\partial(\rho V)}{\partial S}_{\mid V,N} = V \frac{\partial \rho}{\partial S}_{\mid V,N} = \frac{\partial \rho}{\partial s}_{\mid V,N} = \frac{1}{n} \frac{\partial \rho}{\partial \sigma}_{\mid V,N},
\end{equation}
The comoving entropy per particle is
\begin{align}
