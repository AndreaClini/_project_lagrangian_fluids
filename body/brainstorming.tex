...
\begin{align}
    ...
    &=
    \frac{
        \big[Y\partial_Y F- bY\partial_{bY}^2F\big]^2+ b^2 \partial_b^2 F \big[Y \partial_YF- b \partial_b F + Y^2 \partial_Y^2 F\big]
    }
    {
        -\big[b\partial_b F- bY\partial_{bY}^2F\big]^2+ Y^2 \partial_Y^2 F \big[Y \partial_YF- b \partial_b F + b^2 \partial_b^2 F\big]
    }.
\end{align}
{\color{red}
Subtracting from the expression for $c_s^2$ we finally get
\begin{align}
    c_s^2 - c_a^2
    &=
...
\end{align}
This shows that the non-barotropic contribution to the sound speed is always negative (or zero),
\begin{equation}
    c_s^2 \leq c_a^2,
\end{equation}
