...
\begin{aligned}
    ...
    &\quad + a^4\,\,\bigg\{3\phi(\partial_j \pi^j)\bar{b}^2 F_{bb}\,
    +\psi(\partial_j \pi^j)\!\left(\bar{b}F_b - \bar{b}\bar{y}F_{by}\right) \bigg\}\,,
\end{aligned}
\end{align}}
where
{\small
...
\begin{aligned}
    ...
    &\quad-\tfrac{a^4}{y^2F_{yy}}\Big[\big({y}F_y - byF_{by}\big) 3\phi+ y^2 F_{yy}\, \psi\Big]\\
