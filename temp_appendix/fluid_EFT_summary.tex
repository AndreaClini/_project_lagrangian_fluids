...
\end{align}}
In this case we can show explicitly that indeed\todotag{Write better this bit}
\begin{align}
    c_a^2=c_s^2=\frac{\dot{\bar{p}}}{\dot{\bar{\rho}}}= \frac{d (w\rho)}{d \rho}=\frac{b^2F_{bb}}{bF_b}\,.
\end{align}
