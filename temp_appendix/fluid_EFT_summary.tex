...
Adiabatic sound speed $c_a^2$ and non-adiabatic pressure coefficient $\Gamma$ are then by definition\todotag{Write exp that makes manifest the baroropic limit $f_y=0$}
