...
{\small\begin{align}\label{eq:thermo_variables_barotropic}
    \rho=-F,\,\,\, p=F-bF_b,\,\,\, w=\frac{bF_b-F}{F},\,\,\, n=b,\,\,\, \mu=F_b,\,\,\, T=y\,\,\,\, s\equiv0,\,\,\, \frac{d p}{d \rho}=c_a^2=\frac{b^2F_{bb}}{bF_b}.
\end{align}}
...
\begin{align}
    c_s^2\overset{\text{shown above}}{=}c_a^2:=\frac{dp}{d\rho}=\frac{\tfrac{dp}{db}\cancel{db}}{\tfrac{d\rho}{db}\cancel{db}}= \frac{b^2F_{bb}}{bF_b}=\frac{\tfrac{dp}{db}\cancel{\tfrac{db}{dt}dt}}{\tfrac{d\rho}{db}\cancel{\tfrac{db}{dt}dt}}=
