...
\end{align}
The invariants are again the number density $n\equiv b$ for
\begin{align}
    b=\sqrt{\det B}\quad \text{for}\quad
    B^{ij}= g^{\mu\nu} \partial_\mu \phi^i \partial_\nu \phi^j,
\end{align}
and the temperature $T\equiv y$ for
\begin{align}
    y= u^\mu \partial_\mu \phi^0
    \quad\text{for}\quad u^\mu=& \frac{1}{\sqrt{-g}\, 6b} \epsilon^{\mu \alpha \beta \gamma} \epsilon_{ijk} \, \partial_\alpha \phi^i \partial_\beta \phi^j \partial_\gamma \phi^k \propto\,  \star(d\phi^1\wedge d\phi^2\wedge d \phi^3).
\end{align}
...
Finally, collecting terms, the quadratic action read
{\small
\begin{align}
\begin{aligned}
    S^{(2)}=
