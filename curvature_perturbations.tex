...
\end{aligned}
\end{align}
We then identify the peculiar velocity $au^\mu =a(1+\dots, v^\ell)$ and the velocity potential (for phonons/scalar perturbations) as
\begin{align}
...
\end{align}
The comoving curvature perturbation on comoving slices $\zeta$ in Newtonian gauge is then identified in terms of phonons and metric perturbations as
\begin{equation}
    \zeta = -\Psi -\mathcal{H}v = -\Psi + \mathcal{H}\,\dot{\pi}_L\,.
\end{equation}
We may now replace this into the EoM for phonons to get the behavior on superhorizon scales...
