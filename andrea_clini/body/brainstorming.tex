...
{\small 
\begin{align}
    g_{\mu\nu}=a^2\Big(\eta_{\mu\nu}+h_{\mu\nu}\Big)\,,\quad g^{\mu\nu}=a^{-2}\Big(\eta^{\mu\nu}-h^{\mu\nu}\Big)\quad \text{with} \quad h^{\mu\nu}=\eta^{\mu\alpha}\eta^{\nu\beta}h_{\alpha\beta},\quad \sqrt{|g|}= a^4\big(1+\tfrac12 h^{\mu\nu}\eta_{\mu\nu} +O(h^2)\big)\,.
\end{align}
}
...
\begin{align}
    ...
    &+\tfrac12 \bigg(\left[1 + \tfrac12 h^{ii}-(\partial_\ell\pi^\ell)\right]
     \epsilon_{i j k}\,\epsilon^{0 \alpha j k}\,\partial_\alpha\pi^i 
     +\epsilon_{ijk}\, \epsilon^{0 i \beta\gamma}\partial_\beta\pi^j\,\partial_\gamma\pi^k\bigg)
     +\tfrac12 \partial_\mu \pi^0 \epsilon_{i j k}\,\epsilon^{\mu \alpha j k}\,\partial_\alpha\pi^i
\end{align}
}
That is to say 
