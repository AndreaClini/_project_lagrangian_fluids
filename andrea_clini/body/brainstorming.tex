...
\begin{align}
    ...
    \\
    &+\frac{1}{6}\left[1 + \tfrac12 h^{ii}-(\partial_\ell\pi^\ell)\right]
    \underbrace{\epsilon_{ijk} \,\left(\epsilon^{\mu\alpha j k}\partial_\alpha\pi^i+\epsilon^{\mu i \beta k}\partial_\beta\pi^j+\epsilon^{\mu i j \gamma}\partial_\gamma\pi^k\right)}_{=3\, \epsilon_{i j k}\,\epsilon^{\mu \alpha j k}\,\partial_\alpha\pi^i \text{ by symmetry}}\\
    &+\frac{1}{6}\underbrace{\epsilon_{ijk} \,\left(\epsilon^{\mu i \beta\gamma}\partial_\beta\pi^j\,\partial_\gamma\pi^k + \epsilon^{\mu \alpha j \gamma}\,\partial_\alpha\pi^i\,\partial_\gamma\pi^k + \epsilon^{\mu \alpha \beta k}\,\partial_\alpha\pi^i\,\partial_\beta\pi^j\right)}_{=3\, \epsilon_{ijk}\, \epsilon^{\mu i \beta\gamma}\partial_\beta\pi^j\,\partial_\gamma\pi^k \text{ by symmetry}}
    + O(\pi^3, h^2)\\
    =&\delta_0^\mu \bigg(1 \!+\! \Big[\tfrac12 h^{00} -(\partial_j \pi^j)\Big]\! +\! \Big[ h^{0 i} \dot{\pi}^i + \big(h^{ii}-\tfrac12 h^{00}\big) (\partial_j \pi^j) + \tfrac12 (\dot{\pi}^i)^2 + \tfrac12 (\partial_j \pi^j)^2 +\tfrac12 \partial_i\pi^j\partial_j\pi^i\Big]\bigg)
    \\
    &+\frac{1}{2}\left[1 + \tfrac12 h^{ii}-(\partial_\ell\pi^\ell)\right]
...
\begin{align}
    ...
    =& \big(\delta_\mu^0 + \partial_\mu \pi^0\big) \delta_0^\mu \bigg(1 \!+\! \Big[\tfrac12 h^{00} -(\partial_j \pi^j)\Big]\! +\! \Big[ h^{0 i} \dot{\pi}^i + \big(h^{ii}-\tfrac12 h^{00}\big) (\partial_j \pi^j) + \tfrac12 (\dot{\pi}^i)^2 + \tfrac12 (\partial_j \pi^j)^2 +\tfrac12 \partial_i\pi^j\partial_j\pi^i\Big]\bigg)\\
    &+ \tfrac12 \big(\delta_\mu^0 + \partial_\mu \pi^0\big)\bigg(\left[1 + \tfrac12 h^{ii}-(\partial_\ell\pi^\ell)\right]
     \epsilon_{i j k}\,\epsilon^{\mu \alpha j k}\,\partial_\alpha\pi^i 
     +\epsilon_{ijk}\, \epsilon^{\mu i \beta\gamma}\partial_\beta\pi^j\,\partial_\gamma\pi^k\bigg)
    \\
    =& \bigg(1 \!+\! \Big[\tfrac12 h^{00} -(\partial_j \pi^j)\Big]\! +\! \Big[ h^{0 i} \dot{\pi}^i + \big(h^{ii}-\tfrac12 h^{00}\big) (\partial_j \pi^j) + \tfrac12 (\dot{\pi}^i)^2 + \tfrac12 (\partial_j \pi^j)^2 +\tfrac12 \partial_i\pi^j\partial_j\pi^i\Big]\bigg)
    +\dot{\pi}^0 \bigg(1 \!+\! \Big[\tfrac12 h^{00} -(\partial_j \pi^j)\Big]\bigg)\\
    &+\tfrac12 \bigg(\left[1 + \tfrac12 h^{ii}-(\partial_\ell\pi^\ell)\right]
    ...
    =& \bigg(1 \!+\! \Big[\tfrac12 h^{00} -(\partial_j \pi^j)\Big]\! +\! \Big[ h^{0 i} \dot{\pi}^i + \big(h^{ii}-\tfrac12 h^{00}\big) (\partial_j \pi^j) + \tfrac12 (\dot{\pi}^i)^2 + \tfrac12 (\partial_j \pi^j)^2 +\tfrac12 \partial_i\pi^j\partial_j\pi^i\Big]\bigg)
    +\dot{\pi}^0 \bigg(1 \!+\! \Big[\tfrac12 h^{00} -(\partial_j \pi^j)\Big]\bigg)\\
    &+(\partial_j\pi^j) +\tfrac12 h^{ii}(\partial_j\pi^j)-(\partial_j\pi^j)^2 +\tfrac12(\partial_j\pi^j)^2-\tfrac12(\partial_k\pi^j\,\partial_j\pi^k)
...
\begin{align}
    ...
    &+\! \Big[\tfrac12 h^{00}\dot{\pi}^0+ h^{0 i} \dot{\pi}^i + \big(h^{ii}-\tfrac12 h^{00}\big) (\partial_j \pi^j)\graycancel{-\dot{\pi}^0(\partial_j \pi^j)} + \tfrac12 (\dot{\pi}^i)^2 +\redcancel{ \tfrac12 (\partial_j \pi^j)^2} +\greencancel{\tfrac12 \partial_i\pi^j\partial_j\pi^i}\Big]\bigg)\\
    &+\bluecancel{(\partial_j\pi^j)} +\tfrac12 h^{ii}(\partial_j\pi^j)\redcancel{-(\partial_j\pi^j)^2} +\redcancel{\tfrac12(\partial_j\pi^j)^2}\greencancel{-\tfrac12(\partial_k\pi^j\,\partial_j\pi^k)}
    +\graycancel{\dot{\pi}^0(\partial_j\pi^j)}-\partial_j\pi^0\dot{\pi}^j\\
    =& \bigg(1 \!+\! \Big[\tfrac12 h^{00}+ \dot{\pi}^0\Big]
    +\! \Big[\tfrac12 h^{00}\dot{\pi}^0+ h^{0 i} \dot{\pi}^i + \big(\tfrac32 h^{ii}-\tfrac12 h^{00}\big) (\partial_j \pi^j) + \tfrac12 (\dot{\pi}^i)^2 -\partial_j\pi^0\dot{\pi}^j\Big]\bigg).
\end{align}
}
...
\begin{align}
    ...
    &\delta y^{(2)} = \tfrac12 h^{00}\dot{\pi}^0+ h^{0 i} \dot{\pi}^i + \big(\tfrac32 h^{ii}-\tfrac12 h^{00}\big) (\partial_j \pi^j) + \tfrac12 (\dot{\pi}^i)^2 -\partial_j\pi^0\dot{\pi}^j.
\end{align}
}
...
\begin{align}
    ...
    \\
    &\quad + (\bar{y}F_y) \Big[ \tfrac12 h^{00}\dot{\pi}^0+ h^{0 i} \dot{\pi}^i + \big(\tfrac32 h^{ii}-\tfrac12 h^{00}\big) (\partial_j \pi^j) + \tfrac12 (\dot{\pi}^i)^2 -\partial_j\pi^0\dot{\pi}^j\Big]
    \\
...
\begin{align}
    ...
    \bigg\}\\
    &\quad + a^4\,\,\bigg\{
    \tfrac12\!\left(\bar{b}F_b + 3\bar{y}F_y - \bar{b}^2 F_{bb}\right) h^{ii}(\partial_j \pi^j)
    + \tfrac12\!\left(-2\bar{b}F_b - \bar{y}F_y + \bar{b}\bar{y}F_{by}\right) h^{00}(\partial_j \pi^j)
